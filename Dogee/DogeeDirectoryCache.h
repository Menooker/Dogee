...
//	struct CacheBlock
//	{
//		uint64_t cache[1 << DSM_CACHE_BITS];
//		unsigned long lru;
//		uint64_t key;
//		BD_RWLOCK lock;
//	};
...
//				uint64_t addr;
//				uint64_t buf[DSM_CACHE_BLOCK_SIZE];
//			};
...
//#pragma pack(pop)
//
//			void ServerRenewChunk(uint64_t addr, int src_id, uint64_t* v);
//			void ServerWriteChunk(uint64_t addr, int src_id, uint64_t* v);
//			void ServerRenew(uint64_t addr, int src_id, uint64_t v);
//			void ServerWrite(uint64_t addr, int src_id, uint64_t v);
//			void ServerWriteback(uint64_t addr, int src_id);
//			CacheMessageKind ServerWriteMiss(uint64_t addr, int src_id, uint64_t v, uint64_t* outbuf);
//			CacheMessageKind ServerReadMiss(uint64_t addr, int src_id, uint64_t* outbuf);
//
...
//			void WriteChunk(uint64_t addr, uint64_t* v);
//
//			/*
...
//			*/
//			SoStatus WriteMiss(uint64_t addr, uint64_t v, CacheBlock* blk);
